...
double Perlin3D::getChunk(int x , int y , int z) const
{
    return _chunk[x][y][z];
}

bool Perlin3D::isChunkTrue(int x, int y, int z) const
{
    return getChunk(x,y,z) > 0.5;
}

int Perlin3D::getChunkSize() const
{
    return _chunkSide;
}
